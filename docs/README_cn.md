...
- **加入社区：** 加入 Agent Zero [Skool](https://www.skool.com/agent-zero) 或 [Discord](https://discord.gg/Z2tun2N3) 社区，讨论想法、提问并与其他贡献者协作。
- **分享您的作品：** 在我们的 GitHub [展示和交流](https://github.com/agent0ai/agent-zero/discussions/categories/show-and-tell) 区域分享您的 Agent Zero 作品、工作流程和发现。
- **报告问题：** 使用 [GitHub 问题跟踪器](https://github.com/agent0ai/agent-zero/issues) 报告与框架相关的错误或建议新功能。

## 目录

- [欢迎来到 Agent Zero 文档](#agent-zero-documentation)
  - [您的 Agent Zero 体验](#your-experience-with-agent-zero-starts-now)
...
- [架构概览](architecture.md)
  ...
  - [核心组件](architecture.md#core-components)
    ...
    - [内存系统](architecture.md#3-memory-system)
    - [消息历史和总结](archicture.md#messages-history-and-summarization)
    - [提示](architecture.md#4-prompts)
    - [知识](architecture.md#5-knowledge)
    - [仪器](architecture.md#6-instruments)
    - [扩展](architecture.md#7-extensions)
  - [贡献](contribution.md)
  - [开始](contribution.md#getting-started)
  - [进行更改](contribution.md#making-changes)
  - [提交拉取请求](contribution.md#submitting-a-pull-request)
  - [文档技术栈](contribution.md#documentation-stack)
